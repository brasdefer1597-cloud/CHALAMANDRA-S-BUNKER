...
import { Crown, User, Castle, BookOpen, ShieldAlert, Users, TrendingUp, Skull, Crosshair, Eye, Briefcase, Activity, type LucideProps } from 'lucide-react';
// FIX: Removed non-existent CaseStudy import from ./types
import { ChessPiece, StrategyTactic } from './types';
import React from 'react';

// FIX: Moved StarIcon definition before its usage in CHESS_PIECES to resolve the "used before its declaration" error.
// Helper component for the Queen icon since Lucide doesn't have a specific Queen piece icon
// FIX: Converted StarIcon to a forwardRef component to match the LucideIcon type.
export const StarIcon = React.forwardRef<SVGSVGElement, LucideProps>((props, ref) => (
    <svg
        ref={ref}
        {...props}
